...
package fr.djaytan.minecraft.playershop.model.dao.api;

import fr.djaytan.minecraft.playershop.model.entity.PlayerShop;
import fr.djaytan.minecraft.playershop.model.dao.Dao;
import java.util.Optional;
import java.util.UUID;
import java.util.concurrent.CompletableFuture;
import org.jetbrains.annotations.NotNull;

public interface PlayerShopDao extends Dao<PlayerShop, Long> {
